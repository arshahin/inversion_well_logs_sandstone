...
xlabel('Acoustic Impedance[Vp*Den](Km/sec*g/cm3)','FontSize',fs)
...
subplot(2,3,1)
scatter(ai(kks:kkf),vr(kks:kkf),mksz,swt(kks:kkf),'filled')
xlabel('Acoustic Impedance(Km/sec*g/cm3)','FontSize',fs)
ylabel('Velocity Ratio [Vp/Vs]','FontSize',fs)
grid on
cmin=0.0; cmax=max(swt(kks:kkf));
c = colorbar; c.Label.String = 'Water Saturation (v/v)';
...
set(gca,'FontSize',fset)
subplot(2,2,2)
histogram(den,nhistogram)
ylabel('Frequency','FontSize',fst)
title('Density (g/cm3)','FontSize',fst)
grid MINOR
grid on
set(gca,'FontSize',fset)
subplot(2,2,3)
histogram(dtco,nhistogram)
ylabel('Frequency','FontSize',fst)
...
% % % % % %         %%%%% rough initial guess for global parameters only
% for better plotting  
...
%%
    ...
    xlim([0 jtemp-1]);
    ylabel('Model parameters','FontSize',fs);    title('Sand Density(g/cm3) ','FontSize',fs);
    ...
    xlim([0 jtemp-1]);
    title('Shale Density(g/cm3)','FontSize',fs);
...
if (nruns>1)
    ...
    figure(12)
    subplot(3,3,1) 
    histogram(err_plt(niter,:),nhistogram)
...
title('Density','FontSize',fst);legend('True','Inverted');xlim(den_xlim);ylim(depth_lim_all); xlabel('g/cm3','FontSize',fst);
...
figure(21)
subplot(2,4,1)
histogram(phii(nsh:nz-nsh),nhistogram)
xlim([0 0.22]);
ylim([0 15]);
ylabel('Frequency','FontSize',fst)
title('Intergranular porosity(v/v)','FontSize',fst)
...
set(gca,'FontSize',fset)
subplot(2,4,2)
histogram(phim(nsh:nz-nsh),nhistogram)
xlim([0 0.22]);
ylim([0 15]);
% % % ylabel('Frequency','FontSize',fst)
title('Micro-porosity(v/v)','FontSize',fst)
...
set(gca,'FontSize',fset)
subplot(2,4,3)
histogram(phit(nsh:nz-nsh),nhistogram)
xlim([0 0.22]);
ylim([0 15]);
% % % ylabel('Frequency','FontSize',fst)
...
set(gca,'FontSize',fset)
subplot(2,4,4)
histogram(swt(nsh:nz-nsh),nhistogram)
% % % ylabel('Frequency','FontSize',fst)
...
subplot(2,4,5)
histogram(phii_mean(nsh:nz-nsh),nhistogram)
xlim([0 0.22]);
ylim([0 15]);
ylabel('Frequency','FontSize',fst)
...
set(gca,'FontSize',fset)
subplot(2,4,6)
histogram(phim_mean(nsh:nz-nsh),nhistogram)
xlim([0 0.22]);
ylim([0 15]);
% % % ylabel('Frequency','FontSize',fst)
...
set(gca,'FontSize',fset)
subplot(2,4,7)
histogram(phit_mean(nsh:nz-nsh),nhistogram)
xlim([0 0.22]);
ylim([0 15]);
% % % ylabel('Frequency','FontSize',fst)
...
set(gca,'FontSize',fset)
subplot(2,4,8)
histogram(swt_mean(nsh:nz-nsh),nhistogram)
xlim([0 1]);
ylim([0 50]);
% % % ylabel('Frequency','FontSize',fst)
...
figure(22)
subplot(2,4,1)
histogram(resist(nsh:nz-nsh),nhistogram)
ylabel('Frequency','FontSize',fst)
title('Resistivity (ohm-m)','FontSize',fst)
grid MINOR
grid on
set(gca,'FontSize',fset)
subplot(2,4,2)
histogram(den(nsh:nz-nsh),nhistogram)
xlim([2.0 2.5]);
ylim([0 15]);
% % ylabel('Frequency','FontSize',fst)
title('Density (g/cm3)','FontSize',fst)
...
set(gca,'FontSize',fset)
subplot(2,4,3)
histogram(dtco(nsh:nz-nsh),nhistogram)
% % ylabel('Frequency','FontSize',fst)
xlim([250 450]);
ylim([0 15]);
title('DTCO(microsec/m)','FontSize',fst)
...
set(gca,'FontSize',fset)
subplot(2,4,4)
histogram(dtsm(nsh:nz-nsh),nhistogram)
% % % ylabel('Frequency','FontSize',fst)
title('DTSM (microsec/m)','FontSize',fst)
grid MINOR
grid on
set(gca,'FontSize',fset)
subplot(2,4,5)
histogram(resist_sim_mean,nhistogram)
ylabel('Frequency','FontSize',fst)
...
set(gca,'FontSize',fset)
subplot(2,4,6)
histogram(den_sim_mean,nhistogram)
xlim([2.0 2.5]);
ylim([0 15]);
% % % ylabel('Frequency','FontSize',fst)
title('Inverted Density (g/cm3)','FontSize',fst)
grid MINOR
grid on
set(gca,'FontSize',fset)
subplot(2,4,7)
histogram(dtp_sim_mean,nhistogram)
xlim([250 450]);
ylim([0 15]);
% % % ylabel('Frequency','FontSize',fst)
...
set(gca,'FontSize',fset)
subplot(2,4,8)
histogram(dts_sim_mean,nhistogram)
ylim([0 12]);
% % % ylabel('Frequency','FontSize',fst)
...
if nruns>1
    ...
    subplot(1,6,3)
        ...
        title('Density','FontSize',fst);
        xlim(den_xlim);ylim(depth_lim_all); xlabel('g/cm3','FontSize',fst);grid MINOR;grid on;set(gca,'YDir','reverse','FontSize',fset)
...
%%   
    ...
    array_min=-0.2;
    array_max=0.6;
    [hist2d_stick,meshx,meshy]=hist2d(array,array_min,array_max,nbins,nsmth,msmth);
    contourf(meshx,meshy,hist2d_stick,ncount)
    colorbar
    colormap(cool)
    hold on
    plot(err_true,'dk','LineWidth',lw)
    hold on
    plot(real(err_mean_line),'g','LineWidth',lw)
    xlim([0 jtemp-1]); grid;
...
%%
    ...
    colormap(cool) 
    hold on
    plot(lamdai_true,'dk','LineWidth',lw)
    hold on
    plot(lamdai_plt_mean,'g','LineWidth',lw)
    xlim([0 jtemp-1]);
% %     ylabel('Model parameters','FontSize',fs);    
    title('Sand Lithology Exponent','FontSize',fs);
    %%%%ylim(lamdai_lim);
    grid; set(gca,'FontSize',fs) 
   %%
    subplot(3,5,3)
    array=phic_plt';  
    array_min=0.1;
    ...
    colormap(cool) 
    hold on
    plot(phic_true,'dk','LineWidth',lw)
    hold on
    plot(phic_plt_mean,'g','LineWidth',lw)
    xlim([0 jtemp-1]);
% %     ylabel('Model parameters','FontSize',fs);   
    title('Critical Porosity(v/v)','FontSize',fs);
    %%ylim(phic_lim);
    ...
    colormap(cool) 
    hold on
    plot(Cx_true,'dk','LineWidth',lw)
    hold on
    plot(Cx_plt_mean,'g','LineWidth',lw)
    xlim([0 jtemp-1]);
    ylabel('Model parameters','FontSize',fs);    title('Salinity (Kppm)','FontSize',fs);
    %%ylim(Cx_lim);
    grid; set(gca,'FontSize',fs) 
    ...
    colormap(cool) 
    hold on
    plot(Lik_true,'dk','LineWidth',lw)
    hold on
    plot(Lik_plt_mean,'g','LineWidth',lw)
    xlim([0 jtemp-1]);
    title('Sand L Bulk Modulus ','FontSize',fs);
    %%ylim(Lik_lim);
    grid; set(gca,'FontSize',fs) 
    ...
    colormap(cool) 
    hold on
    plot(Limu_true,'dk','LineWidth',lw)
     hold on
    plot(Limu_plt_mean,'g','LineWidth',lw)
    xlim([0 jtemp-1]);
    title('Sand L Shear Modulus ','FontSize',fs);
    %%ylim(Limu_lim); 
    grid;  set(gca,'FontSize',fs) 
    ...
    colormap(cool) 
    hold on
    plot(rhos_true,'dk','LineWidth',lw)
    hold on
    plot(rhos_plt_mean,'g','LineWidth',lw)
    xlim([0 jtemp-1]);
    ylabel('Model parameters','FontSize',fs);    title('Sand Density(g/cm3) ','FontSize',fs);
    %%ylim(rhos_lim); 
    grid;  set(gca,'FontSize',fs) 
%% 
    ...
    colormap(cool) 
    hold on
    plot(ks_true,'dk','LineWidth',lw)
    hold on
    plot(ks_plt_mean,'g','LineWidth',lw)
    xlim([0 jtemp-1]);
    title('Sand Bulk Modulus(GPa) ','FontSize',fs);
    %%ylim(ks_lim); 
    grid;  set(gca,'FontSize',fs) 
%%     
    ...
    colormap(cool) 
    hold on
    plot(mus_true,'dk','LineWidth',lw)
    hold on
    plot(mus_plt_mean,'g','LineWidth',lw)
    xlim([0 jtemp-1]);
    title('Sand Shear Modulus(GPa) ','FontSize',fs);
    %%ylim(mus_lim); 
    grid;  set(gca,'FontSize',fs) 
%%     
    ...
    colormap(cool) 
    hold on
    plot(phicl_true,'dk','LineWidth',lw)
    hold on
    plot(phicl_plt_mean,'g','LineWidth',lw)
    xlim([0 jtemp-1]);
    title('Shale Porosity(v/v)','FontSize',fs);
    %%ylim(phicl_lim); 
    xlabel('Iteration number','FontSize',fs);
...
%%    
    ...
    colormap(cool) 
    hold on
    plot(rhocl_true,'dk','LineWidth',lw)
    hold on
    plot(rhocl_plt_mean,'g','LineWidth',lw)
    xlim([0 jtemp-1]);
    title('Shale Density(g/cm3)','FontSize',fs);
    %%ylim(rhocl_lim); 
    xlabel('Iteration number','FontSize',fs);    
...
%%    
    ...
    colormap(cool) 
    hold on
    plot(kcl_true,'dk','LineWidth',lw)
    hold on
    plot(kcl_plt_mean,'g','LineWidth',lw)
    xlim([0 jtemp-1]);
    title('Shale Bulk Modulus(GPa)','FontSize',fs);
    %%ylim(kcl_lim); 
    xlabel('Iteration number','FontSize',fs);
...
%%    
    ...
    colormap(cool) 
    hold on
    plot(mucl_true,'dk','LineWidth',lw)
    hold on
    plot(mucl_plt_mean,'g','LineWidth',lw)
    xlim([0 jtemp-1]);
    title('Shale Shear Modulus(GPa)','FontSize',fs);
    %%ylim(mucl_lim);
    xlabel('Iteration number','FontSize',fs);    
...
%%     
    ...
    colormap(cool) 
    hold on
    plot(grcl_true,'dk','LineWidth',lw)
    hold on
    plot(grcl_plt_mean,'g','LineWidth',lw)
    xlim([0 jtemp-1]);
    title('Shale Gamma Ray(API)','FontSize',fs);
    %%ylim(grcl_lim);
    xlabel('Iteration number','FontSize',fs);    
...
%%     
    ...
    colormap(cool) 
    hold on
    plot(grma_true,'dk','LineWidth',lw)
    hold on
    plot(grma_plt_mean,'g','LineWidth',lw)
    xlim([0 jtemp-1]);
    title('Sand Gamma Ray(API)','FontSize',fs);
    %%ylim(grma_lim); 
    grid;  set(gca,'FontSize',fs) 
...
if nruns>1
    nrunny=1:nruns;    
    subplot(1,7,1)
        array=phii_opt(runy,nsh:nz-nsh);  
        array_min=-0.05;
        array_max=0.40;
        arary_mean=phii_mean(nsh:nz-nsh);
        array_true=phii(nsh:nz-nsh);
        [hist2d_stick,meshx,meshy]=hist2d(array,array_min,array_max,nbins,nsmth,msmth);
        contourf(meshy,meshx,hist2d_stick,ncount)
        %colorbar
        colormap(cool)
        hold on       
        plot(array_true,dep1,'dy','LineWidth',lw)  
        hold on
        plot(arary_mean,dep1,'g','LineWidth',lw)  
        title('Sand Porosity','FontSize',fst)
        ylabel('Relative Depth(m)','FontSize',fsy)
        grid MINOR; grid on; 
        xlabel('(v/v)','FontSize',fst);
        yticks([1 35 70 105 140])
        yticklabels({'5','10','15','20','25'})
        set(gca,'YDir','reverse','FontSize',fset)
        
        subplot(1,7,2)
        array=phiiw_opt(runy,nsh:nz-nsh);  
        array_min=-0.05;
        array_max=0.40;
        arary_mean=phiiw_mean(nsh:nz-nsh);
        array_true=phiiw(nsh:nz-nsh);
        [hist2d_stick,meshx,meshy]=hist2d(array,array_min,array_max,nbins,nsmth,msmth);
        contourf(meshy,meshx,hist2d_stick,ncount)
        %colorbar
        colormap(cool)
        ...
        hold on
        plot(arary_mean,dep1,'g','LineWidth',lw)  
        title('Water-filled Porosity','FontSize',fst)
        grid MINOR; grid on; 
        xlabel('(v/v)','FontSize',fst);
        yticks([1 35 70 105 140])
        yticklabels({'5','10','15','20','25'})
        ...
        subplot(1,7,3)
        array=phit_opt(runy,nsh:nz-nsh);  
        array_min=-0.05;
        array_max=0.40;
        arary_mean=phit_mean(nsh:nz-nsh);
        array_true=phit(nsh:nz-nsh);
        [hist2d_stick,meshx,meshy]=hist2d(array,array_min,array_max,nbins,nsmth,msmth);
        contourf(meshy,meshx,hist2d_stick,ncount)
        %colorbar
        colormap(cool)
        ...
        subplot(1,7,4)
        array=den_sim_ppd(nsh:nz-nsh);  
        array_min=1.8;
        array_max=2.6;
        arary_mean=den_sim_mean;
        array_true=den(nsh:nz-nsh);
        [hist2d_stick,meshx,meshy]=hist2d(array,array_min,array_max,nbins,nsmth,msmth);
        contourf(meshy,meshx,hist2d_stick,ncount)
        %colorbar
        colormap(cool)
        ...
        title('Density','FontSize',fst)
        grid MINOR; grid on; 
        xlabel('(g/cm3)','FontSize',fst);
        yticks([1 35 70 105 140])
        yticklabels({'5','10','15','20','25'})
        set(gca,'YDir','reverse','FontSize',fset)
        
        subplot(1,7,5)
        array=resist_sim_ppd(nsh:nz-nsh);  
        array_min=-15;
        array_max=75;
        arary_mean=resist_sim_mean;
        array_true=resist(nsh:nz-nsh);
        [hist2d_stick,meshx,meshy]=hist2d(array,array_min,array_max,nbins,nsmth,msmth);
        contourf(meshy,meshx,(hist2d_stick),ncount)
        %colorbar
        colormap(cool)
        ...
        title('Resistivity','FontSize',fst)
        grid MINOR; grid on; 
        xlabel('(ohm-m)','FontSize',fst);
        yticks([1 35 70 105 140])
        yticklabels({'5','10','15','20','25'})
        set(gca,'YDir','reverse','FontSize',fset)
        
        subplot(1,7,6)
        array=dtp_sim_ppd(nsh:nz-nsh);  
        array_min=200;
        array_max=600;
        arary_mean=dtp_sim_mean;
        array_true=dtco(nsh:nz-nsh);
        [hist2d_stick,meshx,meshy]=hist2d(array,array_min,array_max,nbins,nsmth,msmth);
        contourf(meshy,meshx,(hist2d_stick),ncount)
        %colorbar
        colormap(cool)
        ...
        title('DTCO','FontSize',fst)
        grid MINOR; grid on; 
        xlabel('(microsec/m)','FontSize',fst);
        yticks([1 35 70 105 140])
        yticklabels({'5','10','15','20','25'})
        set(gca,'YDir','reverse','FontSize',fset)
        
        subplot(1,7,7)
        array=dts_sim_ppd(nsh:nz-nsh);  
        array_min=300;
        array_max=1000;
        arary_mean=dts_sim_mean;
        array_true=dtsm(nsh:nz-nsh);
        [hist2d_stick,meshx,meshy]=hist2d(array,array_min,array_max,nbins,nsmth,msmth);
        contourf(meshy,meshx,(hist2d_stick),ncount)
        %colorbar
        colormap(cool)
