function [x_new,pdf,cdf,count]=pdf_combine_reproducable(prior,nx,xmin,xmax,x_old,tmp,w,randf,count,methodmc)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% get the new sample
[x_new,count]=mc_sampling__reproducable(pdf,xmin,xmax,nx,randf,count,methodmc);
